...
Requires: compat-protobuf-soname22-lib = %{version}-%{release}
Requires: compat-protobuf-soname22-license = %{version}-%{release}
Requires: setuptools
Requires: six
...
%package lib
Summary: lib components for the compat-protobuf-soname22 package.
Group: Libraries
Requires: compat-protobuf-soname22-license = %{version}-%{release}

%description lib
lib components for the compat-protobuf-soname22 package.


%package license
Summary: license components for the compat-protobuf-soname22 package.
Group: Default

%description license
license components for the compat-protobuf-soname22 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596514710
...
export SOURCE_DATE_EPOCH=1596514710
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-protobuf-soname22
cp %{_builddir}/protobuf-3.11.4/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname22/1b5a14d06dd784e88dadc5c68344be2dc13875b6
cp %{_builddir}/protobuf-3.11.4/third_party/googletest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname22/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/protobuf-3.11.4/third_party/googletest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname22/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/protobuf-3.11.4/third_party/googletest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname22/5a2314153eadadc69258a9429104cd11804ea304
%make_install
...
/usr/lib64/libprotobuf-lite.so.22.0.4
/usr/lib64/libprotobuf.so.22
/usr/lib64/libprotobuf.so.22.0.4
/usr/lib64/libprotoc.so.22
/usr/lib64/libprotoc.so.22.0.4

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/compat-protobuf-soname22/1b5a14d06dd784e88dadc5c68344be2dc13875b6
/usr/share/package-licenses/compat-protobuf-soname22/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
/usr/share/package-licenses/compat-protobuf-soname22/5a2314153eadadc69258a9429104cd11804ea304
